...
def load() :
    ...
    SquareManagement = os.path.join(os.path.dirname(__file__), "PNG/SquareManagement.png")
    ...
    st.markdown('<div class="logo-container"><img src=SquareManagement></div>', unsafe_allow_html=True)
